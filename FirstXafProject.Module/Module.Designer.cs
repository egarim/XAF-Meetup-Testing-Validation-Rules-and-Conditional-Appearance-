namespace FirstXafProject.Module
{
	partial class FirstXafProjectModule
	{
		/// <summary> 
		...
		{
			// 
			// FirstXafProjectModule
			// 
			//this.AdditionalExportedTypes.Add(typeof(FirstXafProject.Orm.Invoice));
			//this.AdditionalExportedTypes.Add(typeof(FirstXafProject.Orm.Customer));
